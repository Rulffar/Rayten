...
public interface IBanManager
{
    ...
    public void CreateRoleBan<T>(
        ...
        bool skipWebhook = false//rayten
    ) where T : class, IPrototype;
    //rayten-start
    public void CreateDepartmentBan(NetUserId? target, string? targetUsername, NetUserId? banningAdmin, (IPAddress, int)? addressRange, ImmutableTypedHwid? hwid, DepartmentPrototype departmentProto, uint? minutes, NoteSeverity severity, string reason, DateTimeOffset timeOfBan);
    //rayten-end
    /// <summary>
