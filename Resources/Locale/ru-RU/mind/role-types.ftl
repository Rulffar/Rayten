...
# Если вы изменяете цвет здесь, возможно, вам нужно будет также изменить его в файле role_types.yml
