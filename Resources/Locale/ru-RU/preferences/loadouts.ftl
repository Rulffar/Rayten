...
loadout-name-edit-label-dataset = Устанавливает пользовательское имя, которое будет использоваться, если вы играете эту роль. Если оно пустое, будет выбрано случайное имя.
