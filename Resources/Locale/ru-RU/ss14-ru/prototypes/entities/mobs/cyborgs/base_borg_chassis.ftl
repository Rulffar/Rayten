...
ent-BaseXenoborgChassis = ксеноборг
    .desc = Гибрид машины и человека, стремящийся к самовоспроизводству. Они обожают извлекать мозги и вставлять их в новые корпуса ксеноборгов, чтобы пополнить свою армию.
