...
ent-PosterContrabandRealExomorph = ШОК! Экзоморфы СУЩЕСТВУЮТ
...
ent-PosterContrabandRouny = Они скрывают правду о Роуни!
