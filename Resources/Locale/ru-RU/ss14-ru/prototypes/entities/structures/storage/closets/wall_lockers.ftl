...
ent-ClosetWallEmergencyN2 = аварийный шкаф с азотом
...
ent-LockerWallEvacRepair = аварийный шкафчик стены шаттла эвакуации
    .desc = Здесь всё про экстренные ситуации.
ent-LockerWallBasePrisoner = шкафчик заключённого
