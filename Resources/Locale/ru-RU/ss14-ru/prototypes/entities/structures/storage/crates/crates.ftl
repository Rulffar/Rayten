...
ent-CrateRodentCage = хомячья клетка
    .desc = { ent-CrateGeneric.desc }
ent-CrateBaseLockBox = запирающийся ящик
    .desc = Надёжный ящик с замком. Средства от его продажи будут возвращены в отдел. Но помните: Карго всегда берёт свою долю.
ent-CrateLockBoxEngineering = инженерный запирающийся ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = медицинский запирающийся ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = научный запирающийся ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = запирающийся ящик СБ
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = сервисный запирающийся ящик
    .desc = { ent-CrateBaseLockBox.desc }
