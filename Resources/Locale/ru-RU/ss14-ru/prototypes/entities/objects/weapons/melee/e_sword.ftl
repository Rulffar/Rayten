...
ent-HyperEutaticBlade = гиперэвтектический клинок
    .desc = Часто путают с гиперевтактическим клинком. Эта массовая, неоригинальная копия справляется с задачей, но отражает хуже.
# Corvax-HiddenDesc-End
