...
ent-AirGrenade = атмосферная граната
    .desc = Специальная химическая граната, используемая для быстрого заполнения вакуумного пространства воздухом. Заполняет до 30 метров!
