...
ent-CargoRequestEngineeringComputerCircuitboard = консоль
    .desc = Печатная плата для консоли запроса инженерии.
ent-CargoRequestMedicalComputerCircuitboard = плата запроса медицины (консольная плата)
    .desc = Печатная плата для консоли запроса медицинского отдела.
ent-CargoRequestScienceComputerCircuitboard = плата запроса науки (консольная плата)
    .desc = Печатная плата для консоли запроса отдела НИО.
ent-CargoRequestSecurityComputerCircuitboard = плата запроса СБ (консольная плата)
    .desc = Печатная плата для консоли запроса отдела СБ.
ent-CargoRequestServiceComputerCircuitboard = консоль запросов сервиса (консольная плата)
...
ent-StationAiFixerCircuitboard = Консоль восстановления ИИ
