...
ent-MaterialSiloMachineCircuitboard = Силос материалов (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
...
ent-SurveillanceCameraWirelessRouterXenoborgCircuitboard = Беспроводной маршрутизатор камеры ксеноборга
...
ent-MailTeleporterMachineCircuitboard = плата машины телепорта почты
