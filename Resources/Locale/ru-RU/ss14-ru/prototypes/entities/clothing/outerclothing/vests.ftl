...
ent-ClothingOuterVestWebElite = элитный бронированный жилет
    .desc = Синтетическая броня в виде жилета. Этот имеет дополнительное крепление и волокна, устойчивые к высокой температуре.
