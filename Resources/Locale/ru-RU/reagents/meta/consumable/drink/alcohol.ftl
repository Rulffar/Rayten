...
reagent-desc-alien-brain-hemorrhage = Возможно, стоит показаться врачу в Медбее.
...
reagent-desc-bronx = Апельсиновый кузен Манхэттена и Мартини.
...
reagent-name-dark-and-stormy = тёмный и грозовой
reagent-desc-dark-and-stormy = Почти слышны раскаты грома.
...
reagent-desc-eggnog = Яиц маловато будет.
...
reagent-name-jungle-bird = тропическая птица
reagent-desc-jungle-bird = Несмотря на название, не особо популярен среди Воксов.
reagent-name-kalimotxo = калимочо
reagent-desc-kalimotxo = Классный вариант Куба Либре для ценителей алкоголя.
...
reagent-desc-tortuga = Идеально для пиратов, которых выбрали трезвым водителем. Йо-хо-хо!
...
reagent-desc-monkey-business = Интересно, что сами обезьяны думают об этом напитке?
...
reagent-desc-radler = Простой, но классический напиток прямо из Космической Германии.
...
reagent-desc-caipirinha = Специальный коктейль из Сан-Паулу, прямо из старой Бразилии.
reagent-name-daiquiri = дайкири
reagent-desc-daiquiri = Классический ромовый коктейль, который остаётся популярным даже в холодных глубинах космоса.
reagent-name-death-in-the-afternoon = смерть после полудня
reagent-desc-death-in-the-afternoon = "Налейте одну джиггер абсента в бокал для шампанского. Добавьте охлаждённое шампанское, пока оно не приобретёт правильную опалесцирующую мутность. Медленно выпейте три-пять таких." — Эрнест Хемингуэй.
reagent-name-empress-75 = императрица 75
reagent-desc-empress-75 = Более изысканная версия мимозы. Именно такой напиток могла бы потягивать Мария-Антуанетта перед революцией.
reagent-name-espresso-martini = эспрессо-мартини
reagent-desc-espresso-martini = Чтобы взбодрить и расслабить одновременно. Украшен кофейными зёрнами и подаётся ледяным.
reagent-name-mayojito = майохито
reagent-desc-mayojito = Оскорбление богов и людей. Не пейте это.
reagent-name-mimeosa = мимеоза
reagent-desc-mimeosa = Имеет настолько кислый апельсиновый привкус, что его невозможно описать словами.
reagent-name-mimosa = мимоза
reagent-desc-mimosa = Идеальный напиток для весёлого позднего завтрака с подругами.
reagent-name-moscow-mule = московский мул
reagent-desc-moscow-mule = На удивление крепкий и освежающий коктейль, подаётся в культовой медной кружке.
reagent-name-the-sun-also-rises = и солнце восходит
reagent-desc-the-sun-also-rises = Крепкий коктейль, смешанный в мутную смесь. Тайный фаворит измученных писателей.
reagent-name-whiskey-sour = виски сауэр
reagent-desc-whiskey-sour = В чём секретный ингредиент? В яйцах. Это яйца.
