...
reagent-desc-traumoxadone = Криогенный химический препарат. Используется для лечения тяжело повреждённых тканей путём восстановления микрочастицами. Эффективен как для живых, так и для мёртвых пациентов.
