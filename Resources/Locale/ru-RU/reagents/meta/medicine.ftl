...
reagent-desc-traumoxadone = Криогенный химикат. Используется для лечения тяжёло повреждённых тканей путём их восстановления с помощью крошечных частиц в жидкости. Действует вне зависимости от того, жив пациент или мёртв.
...
reagent-desc-stelloxadone = Криогенный химикат. Используется для агрессивного выведения токсинов из организма. Действует вне зависимости от того, жив пациент или мёртв.
