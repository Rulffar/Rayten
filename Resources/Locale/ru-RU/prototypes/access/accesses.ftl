...
id-card-access-level-emergency-shuttle-repeal = Отмена доступа к экстренному шаттлу
...
id-card-access-level-genpop-enter = Войти в общую зону
id-card-access-level-genpop-leave = Покинуть общую зону
