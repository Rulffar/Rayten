...
cmd-set-map-atmos-help = установитьатмосферу <mapid> <space> [<temperature> [moles...]]
...
cmd-set-map-atmos-hint-temp = <temperature> (число с плавающей запятой)
cmd-set-map-atmos-hint-gas = <{ $gas } моли> (число с плавающей запятой)
