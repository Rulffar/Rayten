...
petting-success-scurret = Вы гладите { $target } по { POSS-ADJ($target) } юридически-уникальной голове.
...
petting-failure-scurret = Вы пытаетесь погладить { $target }, но { SUBJECT($target) } делает сальто назад!
