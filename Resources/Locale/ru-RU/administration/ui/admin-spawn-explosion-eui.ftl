...
cmd-explosionui-desc = Открывает окно для удобного управления разрушениями станции.
cmd-explosionui-help = Использование: explosionui
cmd-explosion-desc = Поезд сделал бум
cmd-explosion-help = Использование: explosion [интенсивность] [наклон] [макс. интенсивность] [x y] [mapId] [prototypeId]
...
cmd-explosion-need-coords-explicit = Не удалось получить координаты/карту по трансформации игрока. Нужно указать явно.
