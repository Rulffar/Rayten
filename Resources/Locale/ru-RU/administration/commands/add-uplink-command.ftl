cmd-adduplink-desc = Создаёт аплинк на выбранном предмете и связывает его с аккаунтом пользователя
cmd-adduplink-help = Использование: adduplink [имя_пользователя] [ID_предмета] [скидкаВключена]
