...
uplink-hypereutatic-blade-name = Гиперэвтектический клинок
uplink-hypereutatic-blade-desc = Огромный энергомеч без бренда. Требует обе руки. Медленный и неуклюжий, но неплохо отражает удары. Часто его принимают за Гипертактический клинок.
