...
zombification-resistance-coefficient-value = - [color=violet]Шанс заражения[/color] уменьшен на [color=lightblue]{ $value }%[/color].
zombie-roleban-ghosted = Вы были превращены в призрака, так как у вас бан на роль Зомби.
