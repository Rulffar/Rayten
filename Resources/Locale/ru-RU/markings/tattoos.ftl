...
marking-TattooEyeshadowUpper-tattoo_eyeshadow_upper = Тени (верхние веки)
marking-TattooEyeshadowUpper = Тени (верхние веки)
marking-TattooEyeshadowLower-tattoo_eyeshadow_lower = Тени (нижние веки)
marking-TattooEyeshadowLower = Тени (нижние веки)
marking-TattooEyeshadowLowerReptilian-tattoo_eyeshadow_lower_reptilian = Тени (нижние веки)
marking-TattooEyeshadowLowerReptilian = Тени (нижние веки)
...
marking-TattooEyeshadowVoxLarge-tattoo_eyeshadow_Large = Тени (крупные)
marking-TattooEyeshadowVoxLarge = Тени (крупные)
marking-TattooVoxTailRing-tattoo_vox_tail_ring = Кольцо на хвост
marking-TattooVoxTailRing = Кольцо на хвост
