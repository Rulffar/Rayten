...
bounty-item-remains = Останки улья
...
bounty-description-ring = В этот ВЕЛИКОЛЕПНЫЙ день состоится свадьба семьи Гельтов, но мистер Гельт потерял кольца. Доставьте пару колец.
bounty-description-remains = ДВЕ. ШТУКИ. ОСТАНКОВ УЛЬЯ. Нужно срочно.
bounty-description-plates = Наш клуб коллекционирует трофеи величественных существ, таких как Голиафы. Пришлите несколько пластин - и вознаграждение не заставит себя ждать.
