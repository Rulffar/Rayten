...
ui-options-enable-classic-overlay = Вернуть классический режим оверлея антагониста
...
ui-options-admin-playerlist-character-color = Окрасить имена персонажей-антагонистов
ui-options-admin-playerlist-roletype-color = Окрасить типы ролей
...
ui-options-enable-overlay-symbols = Добавить символ антагониста в текст
ui-options-enable-overlay-playtime = Показывать наигранное время
ui-options-enable-overlay-starting-job = Показывать стартовые роли
ui-options-overlay-merge-distance = Расстояние слияния стеков
ui-options-overlay-ghost-fade-distance = Дистанция затухания оверлея призрака
ui-options-overlay-ghost-hide-distance = Дистанция скрытия оверлея призрака
