...
gas-pressure-regulator-ui-zero-threshold = Обнулить
gas-pressure-regulator-ui-set-to-current-pressure = По входному давлению
...
gas-pressure-regulator-ui-target = Целевое значение
