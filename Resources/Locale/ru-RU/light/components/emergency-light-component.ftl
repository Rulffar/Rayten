...
emergency-light-component-on-examine-alert-withtime = Текущий уровень угрозы станции: [color={ $color }]{ $level }[/color], будет понижен через [bold]{ $time }[/bold].
emergency-light-component-on-examine-alert-sublevel-withtime = Дополнительный код: [color={ $color }]{ $level }[/color], будет снят через [bold]{ $time }[/bold].
emergency-light-component-on-examine-alert-sublevel = Дополнительный код: [color={ $color }]{ $level }[/color].