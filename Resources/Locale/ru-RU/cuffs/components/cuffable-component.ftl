...
cuffable-component-start-uncuffing-self-observer = { $user } начинает расковывать { REFLEXIVE($target) }!
...
cuffable-component-remove-cuffs-push-success-message = Вы успешно снимаете оковы и валите { $otherName } на землю.
